...
try:
    try:
        ...
        # Lightweight fallback accuracy to avoid importing torchvision/timm at module import
        import torch
    ...
    # lightweight fallback to avoid importing timm/torchvision at module import time
    def accuracy(output, target, topk=(1,)):
        with torch.no_grad():
            maxk = max(topk)
            batch_size = target.size(0)
